...
def extract_fingerprint_dataset(dataset_id: int,
                                ...
                                clean: bool = True, verbose: bool = True,  crop_mode="none"):
    """
    ...
    fpe = fingerprint_extractor_class(dataset_id, num_processes, verbose=verbose, crop_mode=crop_mode)
...
def preprocess_dataset(dataset_id: int,
                       ...
                       verbose: bool = False, crop_mode: str = "none") -> None:
    ...
    for n, c in zip(num_processes, configurations):
        ...
        preprocessor = configuration_manager.preprocessor_class(verbose=verbose, crop_mode=crop_mode)
...
def preprocess(dataset_ids: List[int],
               ...
               configurations: Union[Tuple[str], List[str]] = ('2d', '3d_fullres', '3d_lowres'),
               num_processes: Union[int, Tuple[int, ...], List[int]] = (8, 4, 8),
               verbose: bool = False, crop_mode: str = "none"):
    for d in dataset_ids:
        preprocess_dataset(d, plans_identifier, configurations, num_processes, verbose, crop_mode)
