...
class DefaultPreprocessor(object):
    ...
    def run_case_npy(self,case_id, data: np.ndarray, seg: Union[np.ndarray, None], properties: dict,
        ...
        if self.crop_mode=="colon":
            ...
            data, seg, bbox = data, seg, [[0, data.shape[1] - 1],[0, data.shape[2] - 1],[0, data.shape[3] - 1]]
    ...
    def run_case(self, image_files: List[str], seg_file: Union[str, None], plans_manager: PlansManager,
        ...
        data, seg, data_properties = self.run_case_npy(case_id, data, seg, data_properties, plans_manager, configuration_manager,
                                      dataset_json)
