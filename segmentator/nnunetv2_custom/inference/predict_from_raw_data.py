...
from segmentator.nnunetv2_custom.inference.data_iterators import (
...
class nnUNetPredictor(object):
    ...
    def initialize_from_trained_model_folder(
        ...
        trainer_class = recursive_find_python_class(
            join(segmentator.nnunetv2_custom.__path__[0], "training", "nnUNetTrainer"),
            trainer_name,
            "segmentator.nnunetv2_custom.training.nnUNetTrainer",
        )
        if trainer_class is None:
            raise RuntimeError(
                f"Unable to locate trainer class {trainer_name} in segmentator.nnunetv2_custom.training.nnUNetTrainer. "
    ...
    def predict_from_files_sequential(
        ...
        for li, of, sps in zip(
            ...
            ##################################### save_preprocessed_for_classifier ##################################################
