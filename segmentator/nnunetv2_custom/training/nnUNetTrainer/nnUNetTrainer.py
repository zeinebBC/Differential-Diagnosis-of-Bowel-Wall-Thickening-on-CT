...
from segmentator.nnunetv2_custom.configuration import (
    ANISO_THRESHOLD,
    default_num_processes,
)
from segmentator.nnunetv2_custom.evaluation.evaluate_predictions import (
    compute_metrics_on_folder,
)
from segmentator.nnunetv2_custom.inference.export_prediction import (
    export_prediction_from_logits,
    resample_and_save,
)
from segmentator.nnunetv2_custom.inference.predict_from_raw_data import nnUNetPredictor
from segmentator.nnunetv2_custom.inference.sliding_window_prediction import (
    compute_gaussian,
)
from segmentator.nnunetv2_custom.paths import nnUNet_preprocessed, nnUNet_results
from segmentator.nnunetv2_custom.training.data_augmentation.compute_initial_patch_size import (
    get_patch_size,
)
from segmentator.nnunetv2_custom.training.dataloading.data_loader import (
    nnUNetDataLoader,
)
from segmentator.nnunetv2_custom.training.dataloading.nnunet_dataset import (
    infer_dataset_class,
)
from segmentator.nnunetv2_custom.training.logging.nnunet_logger import nnUNetLogger
from segmentator.nnunetv2_custom.training.loss.compound_losses import (
    DC_and_BCE_loss,
    DC_and_CE_loss,
    DC_and_CE_loss_dst,
)
from segmentator.nnunetv2_custom.training.loss.deep_supervision import (
    DeepSupervisionWrapper,
)
from segmentator.nnunetv2_custom.training.loss.dice import (
    MemoryEfficientSoftDiceLoss,
    get_tp_fp_fn_tn,
)
from segmentator.nnunetv2_custom.training.lr_scheduler.warmup import (
    PolyLRScheduler_offset_min,
)
from segmentator.nnunetv2_custom.utilities.collate_outputs import collate_outputs
from segmentator.nnunetv2_custom.utilities.crossval_split import generate_crossval_split
from segmentator.nnunetv2_custom.utilities.default_n_proc_DA import (
    get_allowed_n_proc_DA,
)
from segmentator.nnunetv2_custom.utilities.file_path_utilities import (
    check_workers_alive_and_busy,
)
from segmentator.nnunetv2_custom.utilities.get_network_from_plans import (
    get_network_from_plans,
)
from segmentator.nnunetv2_custom.utilities.helpers import dummy_context, empty_cache
from segmentator.nnunetv2_custom.utilities.label_handling.label_handling import (
    convert_labelmap_to_one_hot,
    determine_num_input_channels,
)
from segmentator.nnunetv2_custom.utilities.plans_handling.plans_handler import (
    PlansManager,
)
...
class nnUNetTrainer(object):
    def __init__(
        ...
        self.num_val_iterations_per_epoch = 75
        self.num_epochs = 200
    ...
    def validation_step(self, batch: dict) -> dict:
        ...
        with (
            ...
            del data
            # l = self.loss(output, target, dst_map)
            l = self.loss(output, target)  # to be edited
            """
            try:
                l = self.loss(output, target, dst_map)
            except TypeError:
