...
from segmentator.nnunetv2_custom.training.loss.robust_ce_loss import (
    RobustCrossEntropyLoss,
    TopKLoss,
)
from segmentator.nnunetv2_custom.training.loss.utils_losses import (
    FocalLoss,
    FocalTverskyLoss,
    JaccardLoss,
)
from segmentator.nnunetv2_custom.utilities.helpers import softmax_helper_dim1
...
class DC_and_CE_loss_dst(nn.Module):
    def __init__(
        self,
        soft_dice_kwargs,
        ce_kwargs,
        ...
        :param weight_dice:
        """
        super(DC_and_CE_loss_dst, self).__init__()
        if ignore_label is not None:
            ce_kwargs["ignore_index"] = ignore_label
...
class CE_and_FocalTverskyLoss(nn.Module):
    def __init__(
        self, focal_tversky_kwargs, ce_kwargs, weight_focal_tversky=1, weight_ce=1
    ):
        super().__init__()
