...
from segmentator.nnunetv2_custom.preprocessing.resampling.utils import (
...
if TYPE_CHECKING:
    ...
    from segmentator.nnunetv2_custom.imageio.base_reader_writer import BaseReaderWriter
    from segmentator.nnunetv2_custom.preprocessing.preprocessors.default_preprocessor import (
        DefaultPreprocessor,
    )
    from segmentator.nnunetv2_custom.utilities.label_handling.label_handling import (
        LabelManager,
...
class ConfigurationManager(object):
    ...
    def preprocessor_class(self) -> Type[DefaultPreprocessor]:
        preprocessor_class = recursive_find_python_class(
            join(segmentator.nnunetv2_custom.__path__[0], "preprocessing"),
            self.preprocessor_name,
            current_module="segmentator.nnunetv2_custom.preprocessing",
        )
...
if __name__ == "__main__":
    from segmentator.nnunetv2_custom.paths import nnUNet_preprocessed
