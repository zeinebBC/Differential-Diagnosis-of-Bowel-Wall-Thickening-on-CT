...
from segmentator.nnunetv2_custom.run.load_pretrained_weights import (
...
def get_trainer_from_args(
    ...
    if nnunet_trainer is None:
        raise RuntimeError(
            ...
            f"segmentator.nnunetv2_custom.training.nnUNetTrainer ("
            f"{join(segmentator.nnunetv2_custom.__path__[0], 'training', 'nnUNetTrainer')}). If it is located somewhere "
